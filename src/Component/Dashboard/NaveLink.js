...
//    
   {maintitle:'إدارة الإجازات',link:'#', permission:'مهام الإدارات',img:'Mask Group 78.png' ,   
    subtitle:[  {link:'LeavesType',title:'انواع الإجازة' },  {link:'AddLeaves',title:'طلب إجازة جديد' },  
        {link:'Leaves',title:'الإجازات'},{link:'LeavesManegment',title:'إدارة طلبات الاجازة'},        
   ...
   {maintitle:'إدارة المرتبات',permission:'إدارة المرتبات', img:'Mask Group 73.png',   
    subtitle:[      
        ...
        // {link:'AddPayroll',title:"اضافة مرتب"},     
        {link:'Allowances',title:"البدلات"},
        ...
        {link:'Deductions',title:"الخصومات والغيابات"},
